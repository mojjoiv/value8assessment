...
def soft_delete_user(%User{} = user) do
  ...
  See `Betting.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Betting.Accounts.User.password_changeset/3` for a list of supported options.
